...
pub(crate) struct ServerEditDraft {
    ...
    e2e_identity_seed: String,
    e2e_local_user_id: u64,
...
impl ServerEditDraft {
    pub(crate) fn from_server(server: &ServerEntry, config: &Config) -> Self {
        ...
        Self {
            ...
            e2e_identity_seed: server.e2e_identity_seed.clone(),
            e2e_local_user_id: server.e2e_local_user_id,
    ...
    pub(crate) fn to_update(&self) -> Result<ServerEditUpdate, String> {
        ...
        let server = ServerEntry {
            ...
            e2e_identity_seed: self.e2e_identity_seed.clone(),
            e2e_local_user_id: self.e2e_local_user_id,
