...
pub(crate) fn trace_output_window(
    ...
    trace.write_event(jsony::object! {
        ...
        max_output_ring_ms: snapshot.max_output_ring_ms,
        neteq_playout_delay_ms: snapshot.neteq_playout_delay_ms,
        neteq_target_ms: snapshot.neteq_target_ms,
        neteq_packet_buffer_ms: snapshot.neteq_packet_buffer_ms,
        neteq_packet_buffer_wait_ms: snapshot.neteq_packet_buffer_wait_ms,
        neteq_packets_buffered: snapshot.neteq_packets_buffered,
