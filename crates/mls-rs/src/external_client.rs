    ...
    C: ExternalClientConfig + Clone,
{
    ...
    pub fn validate_key_package(
        ...
        validate_key_package(&key_package, version, &cs, &id, timestamp)?;
...
pub(crate) mod tests_utils {
    ...
    #[test]
    fn external_client_can_validate_key_package() {
        ...
        let validated_kp = server.validate_key_package(kp.clone(), None).unwrap();
