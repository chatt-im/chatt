...
pub(crate) mod test_utils {
    ...
    impl IdentityProvider for BasicWithCustomProvider {
        ...
        fn identity(
            ...
            self.resolve_custom_identity(signing_id)
        }
        ...
        fn valid_successor(
            ...
            let predecessor = self.resolve_custom_identity(predecessor)?;
            let successor = self.resolve_custom_identity(successor)?;
