...
// Snapshot of the public ABI in the vendored libopus 1.6.1 headers.
// Generated with allowlists for `opus_*`, `Opus*`, and `OPUS_*`; normal builds
// consume this file directly and do not require bindgen or libclang.
