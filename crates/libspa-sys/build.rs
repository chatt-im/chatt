...
fn main() {
    ...
    let builder = bindgen::builder()
        ...
        .allowlist_type("spa_.*")
        .allowlist_var("SPA_.*")
        // bindgen 0.72 does not reliably evaluate these cast-valued macros.
        // They are defined with their stable ABI values in src/lib.rs.
        .blocklist_var("SPA_(TIME|IDX|ID)_INVALID")
