...
#[test]
fn renderer_and_daemon_exchange_protocol_v10_frames_and_live_share_fd() {
    assert_eq!(PROTOCOL_MIN_VERSION, 10);
    assert_eq!(PROTOCOL_MAX_VERSION, 10);
    ...
    assert_eq!(hello.negotiated_version(), Some(10));
