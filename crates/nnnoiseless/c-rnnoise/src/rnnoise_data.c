/* Layer wiring generated from Xiph RNNoise V2 model metadata.
 *
 * The full generated rnnoise_data.c contains many megabytes of embedded arrays.
 * This vendored build uses RNNoise's binary weight-blob loader instead, so only
 * the initializer that maps named arrays onto layers is needed here.
 */
